...
Agent 5: Report Synthesis & Generation
    ↓
Agent 6: PhD-Level Validation & QC
    ↓
...
### Agent 6: PhD-Level Validation & Quality Control

**Purpose**: Research-grade quality assurance before publication

**Input**:
- Complete HTML report from Agent 5
- Original data
- All agent outputs
...
- Taxonomic classifications correct
- Conservation statuses accurate
- Statistical calculations verified
- Geographic data validated
- Units and measurements consistent

**2. Data Quality**:
- Completeness scores reviewed
...
- Institutional branding appropriate

**Output Structure**:
```json
{
  "validationStatus": "PASS",  // or "PASS_WITH_WARNINGS" or "FAIL"
  "qualityScore": 94,  // 0-100
  "validationResults": {
    "scientificAccuracy": {
      "status": "PASS",
      "issues": []
    ...
    "dataQuality": {
      "status": "PASS",
      "completeness": 96,
      "issues": ["2 observations missing elevation data"]
    },
    "narrativeQuality": {
      "status": "PASS",
      "issues": []
    ...
    "fairCompliance": {
      ...
      "accessible": "PASS",
      "interoperable": "PASS",
      "reusable": "WARNING - License not explicitly stated in footer"
    },
  ...
  "recommendations": [
    "Add explicit MIT license statement to footer",
    "Consider adding DOI for long-term archival"
  ],
  "criticalErrors": [],
  "warnings": [
    "License statement missing from footer"
  ]
}
```
...
- **PASS_WITH_WARNINGS**: Minor issues, but acceptable for publication
- **FAIL**: Critical errors found, report CANNOT be published

**Critical Errors** (trigger FAIL):
- Major scientific inaccuracies
- Data completeness < 70%
- Contradictory findings
- Missing required sections
- Severe formatting issues

**Warnings** (allow PASS_WITH_WARNINGS):
- Minor data gaps
- Formatting inconsistencies
- Optional metadata missing
- Non-critical FAIR principle gaps
...
6. Validation Status (Single select: PASS, PASS_WITH_WARNINGS, FAIL)
7. Data Completeness (Number, 0-100)
8. Processing Time (Date & time)
9. Generated By (Single line text) - Default: "Audtheia AI Pipeline"
...
- **Agent 6 (Validation)**: 20-30 seconds
...
3. **Validation Pass Rate**: Target >90%
...
║   AI-Powered Ecological Assessment           ║
║                                              ║
╚══════════════════════════════════════════════╝
```
...
```
┌─────────────────┬─────────────────┬─────────────────┬─────────────────┐
│ Total           │ Unique          │ Conservation    │ Data Quality    │
│ Observations    │ Species         │ Priorities      │ Score           │
│                 │                 │                 │                 │
│      247        │       34        │        8        │     96/100      │
└─────────────────┴─────────────────┴─────────────────┴─────────────────┘
```

### Species Profile Example
```
RUFOUS-TAILED HUMMINGBIRD (Amazilia tzacatl)

Observations: 18
Conservation Status: Least Concern (IUCN)
Rarity Score: 0.23 (Common)
Ecological Role: Pollinator

ANALYSIS:
This species demonstrated peak activity between 0900-1500 local time,
consistent with known diurnal foraging patterns. Observations clustered
in lowland tropical rainforest habitat (elevation 200-600m), with highest
densities near flowering Heliconia and Costus plants.

CONSERVATION SIGNIFICANCE:
As a critical pollinator for 15+ native plant species, this hummingbird
plays an essential role in forest ecosystem function. Current population
appears healthy with no degradation indicators detected.

SATELLITE IMAGERY INTERPRETATION:
[Embedded: 3 satellite images at zoom 10, 12, 14]
Analysis reveals intact forest canopy with minimal fragmentation...
```

---

**Report Generated By**: Audtheia AI Pipeline v1.0  
**Methodology**: 6 AI Agents (OpenAI GPT-4o) + Computer Vision  
**Data Sources**: 72-point comprehensive observations  
